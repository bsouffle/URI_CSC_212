public class Alarm extends Thread implements AlarmInterface {
	...
	//
	// The setPeriod method will set or reset the period by which beeps will
	// occur.
	// Note that the new period will be used after reception of the following
	// beep.
	//
	public void setPeriod(int someDelay) { // Note: The period should be
											// expressed
	...
	//
	// The alarm is a Thread, and the run method gets the thread started, and
	// running.
	//
	public void run() {
